...
final class EnhancedRepairTests: XCTestCase {
  ...
  func testRepairCompressedMimetype() async throws {
  ...
  func testRepairMisorderedMimetype() async throws {
  ...
  func testRepairMissingOPF() async throws {
  ...
  func testRepairCorruptOPFXML() async throws {
  ...
  func testRepairCreatesBackup() async throws {
  ...
  func testRepairRestoresBackupOnFailure() async throws {
