...
struct ZipArchive {
    ...
    private static func parseCentralDirectory(rawData: Data) throws -> [ZipEntry] {
        ...
        while cursor < centralDirectoryOffset + centralDirectorySize {
            ...
            guard signature == 0x02014b50 else { throw ZipError.invalidSignature }
            ...
            guard localSignature == 0x04034b50 else { throw ZipError.invalidSignature }
...
private extension Data {
    ...
    static func decompressDeflate(data: Data, expectedSize: Int) throws -> Data {
    ...
    func findEndOfCentralDirectory() -> Int? {
        ...
        while index >= searchStart {
            if readUInt32LE(at: index) == 0x06054b50 {
                return index
            }
            index -= 1
        }
