...
final class OPFValidationTests: XCTestCase {
    ...
    func testEPUBWithInvalidOPFXMLFails() throws {
    ...
    func testEPUBWithMissingMetadataFails() throws {
        ...
        """
        entries.append(ZipEntry(name: "content.opf", data: Data(opfWithoutMetadata.utf8), compressionMethod: 8))
    ...
    func testEPUBWithEmptySpineFails() throws {
        ...
        """
        entries.append(ZipEntry(name: "content.opf", data: Data(opfWithEmptySpine.utf8), compressionMethod: 8))
        entries.append(ZipEntry(name: "chapter1.html", data: Data("<html><body>Chapter 1</body></html>".utf8), compressionMethod: 8))
        ...
        XCTAssertTrue(result.reason.contains("spine") || result.reason.contains("reading order"), "Error should mention spine")
    }

    func testEPUBWithBrokenManifestReferencesFails() throws {
        ...
        """
        entries.append(ZipEntry(name: "content.opf", data: Data(opfWithBrokenRefs.utf8), compressionMethod: 8))
