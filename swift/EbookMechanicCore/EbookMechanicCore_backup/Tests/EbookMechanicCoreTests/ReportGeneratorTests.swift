...
final class ReportGeneratorTests: XCTestCase {
  func testReportGenerationProducesFile() throws {
    ...
    let reportURL = try generator.generate(
      from: result, rootDirectory: tempDir, corruptedDirectoryName: "CORRUPTED", into: tempDir,
      fileName: "report.md")
    ...
    let secondURL = try generator.generate(
      from: result, rootDirectory: tempDir, corruptedDirectoryName: "CORRUPTED", into: tempDir,
      fileName: "report.md")
