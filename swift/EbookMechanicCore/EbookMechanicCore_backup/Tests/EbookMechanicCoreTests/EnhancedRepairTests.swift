...
final class EnhancedRepairTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempDirectory = fileManager.temporaryDirectory.appendingPathComponent("EnhancedRepairTests-\(UUID().uuidString)")
    ...
    func testRepairCompressedMimetype() throws {
        ...
        entries.append(ZipEntry(name: "mimetype", data: Data("application/epub+zip".utf8), compressionMethod: 8)) // Compressed!
        ...
        """
        entries.append(ZipEntry(name: "META-INF/container.xml", data: Data(containerXML.utf8), compressionMethod: 8))
        ...
        XCTAssertEqual(repairedArchive.entries.first?.compressionMethod, 0, "Mimetype should be uncompressed after repair")
    }
    ...
    func testRepairMisorderedMimetype() throws {
        ...
        """
        entries.append(ZipEntry(name: "META-INF/container.xml", data: Data(containerXML.utf8), compressionMethod: 8))
        entries.append(ZipEntry(name: "mimetype", data: Data("application/epub+zip".utf8), compressionMethod: 0)) // Wrong position!
        entries.append(ZipEntry(name: "content.opf", data: TestFixtures.createMinimalOPF(), compressionMethod: 8))
        entries.append(ZipEntry(name: "chapter1.html", data: Data("<html><body>Chapter 1</body></html>".utf8), compressionMethod: 8))
        ...
        let repairedArchive = try ZipArchive.load(from: epubURL)
        XCTAssertEqual(repairedArchive.entries.first?.name, "mimetype", "Mimetype should be first entry after repair")
    }
    ...
    func testRepairMissingOPF() throws {
        ...
        var entries: [ZipEntry] = []
        entries.append(ZipEntry(name: "mimetype", data: Data("application/epub+zip".utf8), compressionMethod: 0))
    ...
    func testRepairCorruptOPFXML() throws {
        ...
        """
        entries.append(ZipEntry(name: "META-INF/container.xml", data: Data(containerXML.utf8), compressionMethod: 8))
        entries.append(ZipEntry(name: "content.opf", data: Data("This is not valid XML <broken".utf8), compressionMethod: 8))
        entries.append(ZipEntry(name: "chapter1.html", data: Data("<html><body>Chapter 1</body></html>".utf8), compressionMethod: 8))
    ...
    func testRepairCreatesBackup() throws {
        ...
        XCTAssertFalse(fileManager.fileExists(atPath: backupURL.path), "Backup should be removed after successful repair")
    }
