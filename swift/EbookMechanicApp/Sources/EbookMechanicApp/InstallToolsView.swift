    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 20) {
                ...
                Text("Some advanced validation and repair features require external command-line tools. Please install them to enable full functionality.")
                    .font(.body)
                    .multilineTextAlignment(.center)
                    .padding(.horizontal)

                toolStatusRow(name: "EpubCheck", isInstalled: epubcheckInstalled, installCommand: "brew install epubcheck")
                toolStatusRow(name: "PDFCPU", isInstalled: pdfcpuInstalled, installCommand: "brew install pdfcpu")
