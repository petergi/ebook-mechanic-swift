...
- [ ] **Shell completion generation**
  - Generate completions for EbookMechanicEPUBCLI
  - Generate completions for EbookMechanicPDFCLI
  - Install to standard locations
  - Priority: Medium
  - Reference: `Packages/EbookMechanicCLI/Sources/EbookMechanicCLI/ShellCompletion.swift`
...
- [ ] **Create DocC documentation**
  ...
  - Priority: Medium
  - Reference: `Docs/Swift/DOCC_SETUP.md`
